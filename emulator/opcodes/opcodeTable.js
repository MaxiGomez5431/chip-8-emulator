...
export default function createOpcodeTable(chip) {
  return {
    ...
    0x1: (d) => { // Jumps PC to NNN
      chip.pc = d.NNN
      chip.instructionChangePC = true
    }, 
    ...
    0xB: (d) => { //Jumps to the address NNN plus V0.
      chip.pc = chip.V[0] + d.NNN
      chip.instructionChangePC = true
    }, 
    ...
    0xE: (d) => chip.familyE(d), 
    0xF: (d) => chip.familyF(d), 
  }
}